            ...
            <div className="mb-2 wd-navbar-styling">
                <nav className = "navbar py-0">
                    <ul className = "navbar-nav w-100">
                        ...
                        <li className = {`nav-item py-1 px-3 wd-border-bottom ${active === "profile" ? activeClass : active === "edit-profile" ? activeClass : ''}`}><Link to="/tuiter/profile" className = "nav-link wd-override-navlink"><i className = "fas fa-user fa-fw"></i><span className = "d-none d-xl-inline"> Profile</span></Link></li>
